...
public class TransferRepositoryTest extends TestCase {
    ...
    public void findTransfersByFromBill_fail() {
        User user = createUserWithoutId();
        User returnUser = userRepository.save(user);
    ...
    @Test(expected = Exception.class)
    public void findTransfersByToBill_fail() {
        User user = createUserWithoutId();
        User returnUser = userRepository.save(user);
        ...
        BigDecimal sumTransfer1 = BigDecimal.valueOf(createIntRandom());
        Transfer transfer1 = createTransferBetweenBills(testBill, returnUser, sumTransfer1);
        Transfer transfer2 = createTransferBetweenBills(testBill, returnUser, sumTransfer1);
