...
public class UserController {
    ...
    public UserResponse authorizationUser(@PathVariable String login) {return serviceUser .authorizationUser(login);}

    @PostMapping("/delete-user")
    public UserDeleteResponse deleteUser(@RequestBody UUID userId) {return serviceUser.deleteUser(userId);}
}
